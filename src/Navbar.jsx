...
const Navbar = () => {
  return (
    <div>
      <div className="navbar z-30 fixed top-0 w-full  backdrop-blur-lg border border-white/30 text-white">
  ...
  <span className="relative inline-block transition-all duration-500 after:content-['»'] after:absolute after:opacity-0 after:right-[-30px] after:transition-all after:duration-500 hover:after:opacity-100 hover:after:right-15 poppins-extralight font-bold"><a href="#contact">Hire Me</a></span>
</button>
          </div>
        </div>
      </div>
