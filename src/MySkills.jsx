      ...
      <div className="font-[sans-serif] bg-[#1d0e35]">
        <div className="max-w-7xl mx-auto py-16">
          <div className="text-center relative">
            ...
            <motion.div ref={ref} initial="hidden" animate={isInView ? "visible" : "hidden"} variants={paragraphVariants}>
              <p className="poppins-extralight text-xs md:text-sm text-white pt-6 md:pt-10 text-justify md:text-center mr-4 ml-4 md:w-3/4 md:m-auto">
                I’m dedicated to crafting exceptional web experiences, blending creativity with technical expertise...
              </p>
            </motion.div>
          </div>
          ...
          >
            {skillsData.map((slideContent, index) => (
              <SwiperSlide key={index} virtualIndex={index}>
                <Fade cascade>
                  <motion.div
                    variants={iconCard(1.5 + index * 0.5)} 
                    initial="initial"
                    animate="animate"
                  >
                    
                    <div
  className="p-[3px] outer bg-gradient-to-tr from-[#3A1078]  to-purple-400 rounded-tr-[90px] w-[200px] h-[200px] relative bottom-6 left-0 right-0 group"
