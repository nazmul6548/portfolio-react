        ...
        <div className="text-center relative">
          ...
          >
            <p className="poppins-extralight  text-xs md:text-sm text-white pt-6 md:pt-10 text-justify md:text-center mr-4 ml-4 md:w-3/5 md:m-auto">
              I am currently advancing my studies with a Master’s degree,
              following the completion of my Bachelor’s in Social Sciences. My
              educational background includes a strong foundation in Science
              from my earlier academic years, which has fostered my analytical
        ...
        <Fade cascade>
          <div className="grid sm:grid-cols-2 pt-12 gap-6 max-w-6xl mx-auto">
            {[
              {
                year: "2021",
                title: "Masters (admitted)",
                school: "National University",
              },
              {
                year: "2017-2021",
                title: "Hon's Complete (BSS)",
                school: "National University",
              },
              {
                year: "2015-2017",
                title: "HSC (Science)",
                school: "Ahsanullah College",
              },
              {
                year: "2013-2015",
                title: "SSC (Science)",
                school: "Bishwa Darbar High School",
              },
            ].map((item, index) => (
              <div
                key={index}
              ...
              >
                <div className="">
                  <p className="animate__animated animate__bounceInLeft text-[#9b6ef8] text-xl font-bold poppins-extralight">
                    {item.year}
                  </p>

                  <h1 className="animate__animated animate__bounceInRight font-bold text-2xl md:text-3xl merriweather-regular">
                    {item.title}
                  </h1>

                  <p className="text-sm mt-2 poppins-extralight">
                    {item.school}
                  </p>
                </div>
              </div>
