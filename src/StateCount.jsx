...
const StateCount = () => {
  ...
  <div className=" shadow-[0_4px_24px_-8px_rgba(0,0,0,0.2)] grid lg:grid-cols-4 sm:grid-cols-2 sm:gap-24 gap-12 rounded-3xl px-20 py-10">
    <div className="text-center">
      <h3 className="text-4xl font-extrabold text-white">1<span className="text-[#a91079]">Y+</span></h3>
    ...
    <div className="text-center">
      <h3 className="text-4xl font-extrabold text-white">100<span className="text-[#a91079]">K</span></h3>
      <p className="text-gray-500 font-semibold mt-3">Engagement</p>
    </div>
    <div className="text-center">
      <h3 className="text-4xl font-extrabold text-white">99.9<span className="text-[#a91079]">%</span></h3>
